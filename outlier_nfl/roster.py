...
OFFSEASON_MOVES_2026: dict[str, dict[str, Any]] = {
    ...
    "Keenan Allen": {
        "current_team": "IND",
        "former_teams": ["CHI", "Bears", "Chicago", "LAC", "Chargers"],
        "pos": "WR",
        "role": "Starting Wide Receiver",
        "notes": "Acquired by Indianapolis Colts.",
    },
    "Romeo Doubs": {
        "current_team": "NE",
        "former_teams": ["GB", "Packers", "Green Bay"],
        "pos": "WR",
        "role": "Starting Wide Receiver",
        "notes": "Acquired by New England Patriots.",
    },
    "Rico Dowdle": {
        "current_team": "PIT",
        "former_teams": ["DAL", "Cowboys", "Dallas"],
        "pos": "RB",
        "role": "Running Back",
        "notes": "Signed by Pittsburgh Steelers.",
    },
    "Kenneth Gainwell": {
        "current_team": "TB",
        "former_teams": ["PHI", "Eagles", "Philadelphia"],
        "pos": "RB",
        "role": "Running Back",
        "notes": "Signed by Tampa Bay Buccaneers.",
    },
    "Kenny Gainwell": {
        "current_team": "TB",
        "former_teams": ["PHI", "Eagles", "Philadelphia"],
    ...
    "Michael Pittman Jr.": {
        "current_team": "PIT",
        "former_teams": ["IND", "Colts", "Indianapolis"],
        "pos": "WR",
        "role": "Starting Wide Receiver",
        "notes": "Acquired by Pittsburgh Steelers.",
    },
    "Michael Pittman": {
        "current_team": "PIT",
        "former_teams": ["IND", "Colts", "Indianapolis"],
    ...
    "Wan'Dale Robinson": {
        ...
        "former_teams": ["NYG", "Giants", "New York Giants"],
        "pos": "WR",
        "role": "Starting Slot Receiver",
        "notes": "Acquired by Tennessee Titans.",
    },
    "Tank Bigsby": {
        "current_team": "PHI",
        "former_teams": ["JAX", "Jaguars", "Jacksonville"],
        "pos": "RB",
        "role": "Running Back",
        "notes": "Acquired by Philadelphia Eagles.",
    },
    "Jonnu Smith": {
        "current_team": "GB",
        "former_teams": ["MIA", "Dolphins", "Miami", "ATL", "Falcons", "TEN", "Titans"],
        "pos": "TE",
        "role": "Tight End",
        "notes": "Signed by Green Bay Packers.",
    },
    "Jordan Mason": {
        "current_team": "MIN",
        "former_teams": ["SF", "49ers", "San Francisco"],
        "pos": "RB",
        "role": "Running Back",
        "notes": "Signed by Minnesota Vikings.",
    },
    "Jauan Jennings": {
        "current_team": "MIN",
        "former_teams": ["SF", "49ers", "San Francisco"],
        "pos": "WR",
        "role": "Wide Receiver",
        "notes": "Acquired by Minnesota Vikings.",
    },
    "Noah Fant": {
        "current_team": "NO",
        "former_teams": ["SEA", "Seahawks", "Seattle", "DEN", "Broncos"],
        "pos": "TE",
        "role": "Tight End",
        "notes": "Signed by New Orleans Saints.",
    },
    "Kalif Raymond": {
        "current_team": "CHI",
        "former_teams": ["DET", "Lions", "Detroit"],
        "pos": "WR",
        "role": "Wide Receiver",
        "notes": "Signed by Chicago Bears.",
    },
    "Jaleel McLaughlin": {
        "current_team": "CLE",
        "former_teams": ["DEN", "Broncos", "Denver"],
        "pos": "RB",
        "role": "Running Back",
        "notes": "Acquired by Cleveland Browns.",
    },
    "Jahan Dotson": {
        "current_team": "ATL",
        "former_teams": ["PHI", "Eagles", "WAS", "Commanders"],
        "pos": "WR",
        "role": "Wide Receiver",
        "notes": "Acquired by Atlanta Falcons.",
    },
}
...
NFL_2026_FULL_DEPTH_CHARTS: dict[str, dict[str, Any]] = {
    ...
    "ATL": {
        ...
        "wrs": ["Drake London", "Darnell Mooney", "Jahan Dotson", "Ray-Ray McCloud"],
        "te": "Kyle Pitts Sr.",
    },
    "BAL": {
    ...
    "BUF": {
        ...
        "wrs": ["DJ Moore", "Khalil Shakir", "Keon Coleman", "Joshua Palmer"],
        "te": "Dalton Kincaid",
    },
    "CAR": {
    ...
    "CHI": {
        ...
        "wrs": ["Rome Odunze", "Luther Burden III", "Kalif Raymond"],
        "te": "Colston Loveland",
    },
    "CIN": {
    ...
    "CLE": {
        ...
        "rbs": ["Quinshon Judkins", "Jaleel McLaughlin", "Jerome Ford"],
        "wrs": ["KC Concepcion Jr.", "Denzel Boston", "Jerry Jeudy"],
        "te": "Harold Fannin Jr.",
    },
    "DAL": {
        "name": "Dallas Cowboys",
        "starting_qb": "Dak Prescott",
        "rbs": ["Javonte Williams", "Ezekiel Elliott"],
    ...
    "GB": {
        ...
        "rbs": ["MarShawn Lloyd", "Josh Jacobs", "Chris Brooks"],
        "wrs": ["Christian Watson", "Jayden Reed", "Matthew Golden"],
        "te": "Tucker Kraft",
    },
    "HOU": {
        "name": "Houston Texans",
        ...
        "wrs": ["Nico Collins", "Tank Dell", "Kayshon Boutte", "Xavier Hutchinson"],
        "te": "Dalton Schultz",
    },
    "IND": {
        ...
        "wrs": ["Keenan Allen", "Josh Downs", "Alec Pierce"],
        "te": "Tyler Warren",
    },
    "JAX": {
        "name": "Jacksonville Jaguars",
        "starting_qb": "Trevor Lawrence",
        "rbs": ["Bhayshul Tuten", "D'Ernest Johnson"],
    ...
    "KC": {
        ...
        "rbs": ["Kenneth Walker III", "Emmett Johnson", "Carson Steele"],
        "wrs": ["Rashee Rice", "Xavier Worthy", "Justin Watson", "Tyquan Thornton"],
        "te": "Travis Kelce",
    },
    "LAC": {
    ...
    "MIN": {
        ...
        "rbs": ["Aaron Jones Sr.", "Jordan Mason", "Ty Chandler"],
        "wrs": ["Justin Jefferson", "Jordan Addison", "Jauan Jennings"],
        "te": "T.J. Hockenson",
    },
    "NE": {
        ...
        "wrs": ["A.J. Brown", "Romeo Doubs", "DeMario Douglas", "Mack Hollins"],
        "te": "Hunter Henry",
    },
    "NO": {
    ...
    "NYG": {
        ...
        "wrs": ["Malik Nabers", "Darius Slayton", "Jalin Hyatt"],
        "te": "Theo Johnson",
    },
    "NYJ": {
        "name": "New York Jets",
    ...
    "PHI": {
        ...
        "rbs": ["Saquon Barkley", "Tank Bigsby"],
        "wrs": ["DeVonta Smith", "Hollywood Brown", "Dontayvion Wicks", "Makai Lemon"],
        "te": "Dallas Goedert",
    },
    "PIT": {
        "name": "Pittsburgh Steelers",
        "starting_qb": "Aaron Rodgers",
        "rbs": ["Jaylen Warren", "Rico Dowdle"],
        "wrs": ["DK Metcalf", "Michael Pittman Jr.", "Roman Wilson"],
        "te": "Pat Freiermuth",
    },
    "SEA": {
    ...
    "SF": {
        ...
        "wrs": ["Deebo Samuel", "Brandon Aiyuk", "Ricky Pearsall"],
        "te": "George Kittle",
    },
    "TB": {
        "name": "Tampa Bay Buccaneers",
        "starting_qb": "Baker Mayfield",
        "rbs": ["Bucky Irving", "Kenny Gainwell", "Rachaad White"],
    ...
    "TEN": {
        ...
        "wrs": ["Calvin Ridley", "Carnell Tate", "Wan'Dale Robinson"],
        "te": "Chig Okonkwo",
    },
    "WAS": {
