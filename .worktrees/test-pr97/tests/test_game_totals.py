...
@pytest.mark.parametrize(
    ("independent_probability", "expected"),
    [(0.6499, False), (0.65, True)],
)
def test_totals_model_divergence_exact_boundary(independent_probability, expected):
    assert _totals_models_diverge(independent_probability, 0.5) is expected
...
def test_build_game_totals_actionable_at_three_pct_edge():
    games_norm = {
        ...
        "records": [
            _norm_record(
                "m1", 8.5, "OVER", [{"book": "DK", "odds": -125}, {"book": "FD", "odds": -122}]
            ),
            _norm_record(
                "m1", 8.5, "UNDER", [{"book": "DK", "odds": 105}, {"book": "FD", "odds": 102}]
            ),
            _norm_record(
                "m1", 9.0, "OVER", [{"book": "DK", "odds": 110}, {"book": "FD", "odds": 108}]
            ),
            _norm_record(
                "m1", 9.0, "UNDER", [{"book": "DK", "odds": -130}, {"book": "FD", "odds": -128}]
            ),
        ],
    }
    candidates = [
    ...
    if row["edge_pct"] != "" and float(row["edge_pct"]) >= MIN_EDGE_TOTALS:
        ...
        expected_shadow = float(row["edge_pct"]) >= 0.04
        assert (row["shadow_actionable_4pct"] == "true") is expected_shadow
    ...
    side_probability = (
        row["projected_over_prob"] if row["best_side"] == "OVER" else row["projected_under_prob"]
    )
...
def test_build_game_totals_integer_line_push_blocked():
    games_norm = {
        "records": [
            _norm_record(
                "m3", 8.0, "OVER", [{"book": "DK", "odds": -110}, {"book": "FD", "odds": -108}]
            ),
            _norm_record(
                "m3", 8.0, "UNDER", [{"book": "DK", "odds": -110}, {"book": "FD", "odds": -112}]
            ),
            _norm_record(
                "m3", 8.5, "OVER", [{"book": "DK", "odds": -110}, {"book": "FD", "odds": -108}]
            ),
            _norm_record(
                "m3", 8.5, "UNDER", [{"book": "DK", "odds": -110}, {"book": "FD", "odds": -112}]
            ),
        ]
    }
...
def test_build_game_totals_integer_line_with_push_prob():
    games_norm = {
        "records": [
            _norm_record(
                "m3", 7.5, "OVER", [{"book": "DK", "odds": -140}, {"book": "FD", "odds": -140}]
            ),
            _norm_record(
                "m3", 7.5, "UNDER", [{"book": "DK", "odds": 120}, {"book": "FD", "odds": 120}]
            ),
            _norm_record(
                "m3", 8.0, "OVER", [{"book": "DK", "odds": -110}, {"book": "FD", "odds": -110}]
            ),
            _norm_record(
                "m3", 8.0, "UNDER", [{"book": "DK", "odds": -110}, {"book": "FD", "odds": -110}]
            ),
            _norm_record(
                "m3", 8.5, "OVER", [{"book": "DK", "odds": 110}, {"book": "FD", "odds": 110}]
            ),
            _norm_record(
    ...
    candidates = [
        {"market_id": "m3", "line": 8.0, "market_type": "GAMELINE", "_proposition": "TOTAL"}
    ]
    ...
    games_norm = {
        "records": [
            _norm_record(
                ...
                event_starts_at="2020-01-01T00:00:00Z",
            ),
            _norm_record(
                "m4",
                8.5,
            ...
            _norm_record(
                ...
                9.0,
                "OVER",
                [{"book": "DK", "odds": 100}, {"book": "FD", "odds": 102}],
                event_starts_at="2020-01-01T00:00:00Z",
            ),
            _norm_record(
                "m4",
                9.0,
                "UNDER",
                [{"book": "DK", "odds": -120}, {"book": "FD", "odds": -122}],
                event_starts_at="2020-01-01T00:00:00Z",
            ),
        ],
    ...
    games_norm = {
        ...
        "records": [
            _norm_record(
                ...
                8.5,
                "OVER",
                [{"book": "DK", "odds": -125}, {"book": "FD", "odds": -122}],
            ...
            _norm_record(
                ...
                8.5,
                "UNDER",
                [{"book": "DK", "odds": 105}, {"book": "FD", "odds": 102}],
                event_starts_at=None,
            ),
            _norm_record(
                "m6",
            ...
            _norm_record(
                ...
                9.0,
                "UNDER",
                [{"book": "DK", "odds": -130}, {"book": "FD", "odds": -128}],
                event_starts_at=None,
            ),
        ],
    }
...
def test_build_game_totals_stale_source_fails_closed():
    ...
    games_norm = {
        ...
        "records": [
            _norm_record(
                "m7", 8.5, "OVER", [{"book": "DK", "odds": -125}, {"book": "FD", "odds": -122}]
            ),
            _norm_record(
                "m7", 8.5, "UNDER", [{"book": "DK", "odds": 105}, {"book": "FD", "odds": 102}]
            ),
            _norm_record(
                "m7", 9.0, "OVER", [{"book": "DK", "odds": 110}, {"book": "FD", "odds": 108}]
            ),
            _norm_record(
                "m7", 9.0, "UNDER", [{"book": "DK", "odds": -130}, {"book": "FD", "odds": -128}]
            ),
        ],
    }
    row = build_game_totals([], games_norm, sport="MLB", now=now)[0]
...
def test_projected_over_prob_matches_headline_line():
    ...
    games_norm = {
        "records": [
            _norm_record(
                "m5", 8.5, "OVER", [{"book": "DK", "odds": -110}, {"book": "FD", "odds": -110}]
            ),
            _norm_record(
                "m5", 8.5, "UNDER", [{"book": "DK", "odds": -110}, {"book": "FD", "odds": -110}]
            ),
            _norm_record(
                "m5", 9.5, "OVER", [{"book": "DK", "odds": 200}, {"book": "FD", "odds": 200}]
            ),
            _norm_record(
                "m5", 9.5, "UNDER", [{"book": "DK", "odds": -250}, {"book": "FD", "odds": -250}]
            ),
        ]
    }
    candidates = [
        {"market_id": "m5", "line": 8.5, "market_type": "GAMELINE", "_proposition": "TOTAL"}
    ]
    rows = build_game_totals(candidates, games_norm, sport="MLB")
...
def test_mlb_runs_team_total_is_sport_aware():
    ...
    assert is_eligible_total_record(mlb_runs, kind=TOTAL_KIND_TEAM, sport="MLB")
...
def test_build_game_totals_excludes_team_records():
    games_norm = {
        "records": [
            _norm_record(
                "m_game", 8.5, "OVER", [{"book": "DK", "odds": -110}, {"book": "FD", "odds": -110}]
            ),
            _norm_record(
...
def test_build_game_totals_excludes_period_pseudo_markets():
    ...
    games_norm = {
        ...
        "records": [
            ...
            _norm_record(
                "inn6", 1.5, "OVER", books2, period_label="6I", periods=[6], include_overtime=False
            ),
            _norm_record(
                "inn6",
                1.5,
...
def test_build_game_totals_merges_split_full_game_market_ids_into_one_ladder():
    ...
    games_norm = {
        ...
        "records": [
            _norm_record(
                "m-low", 8.0, "OVER", [{"book": "DK", "odds": -140}, {"book": "FD", "odds": -140}]
            ),
            _norm_record(
                "m-low", 8.0, "UNDER", [{"book": "DK", "odds": 120}, {"book": "FD", "odds": 120}]
            ),
            _norm_record(
                "m-high", 9.0, "OVER", [{"book": "DK", "odds": 110}, {"book": "FD", "odds": 110}]
            ),
            _norm_record(
    ...
    games_norm = {
        ...
        "records": [
            _norm_record(
                ...
                stats=_l10_stats(8, 6),
            ),
            _norm_record(
                "m1", 8.5, "UNDER", [{"book": "DK", "odds": 100}, {"book": "FD", "odds": 100}]
            ),
        ],
    }
    rows = build_game_totals(
    ...
    games_norm = {
        ...
        "records": [
            _norm_record(
                ...
                8.5,
                "OVER",
                [{"book": "DK", "odds": 180}, {"book": "FD", "odds": 175}],
                stats=_l10_stats(2, 4),
            ),
            _norm_record(
                "m-low", 8.5, "UNDER", [{"book": "DK", "odds": -220}, {"book": "FD", "odds": -215}]
            ),
            _norm_record(
                "m-high", 10.5, "OVER", [{"book": "DK", "odds": -130}, {"book": "FD", "odds": -128}]
            ),
            _norm_record(
                "m-high", 10.5, "UNDER", [{"book": "DK", "odds": 110}, {"book": "FD", "odds": 108}]
            ),
        ],
    }
    candidates = [
        {"market_id": "m-low", "market_type": "GAMELINE", "line": 8.5, "_proposition": "TOTAL"}
    ]
...
def test_build_game_totals_l10_can_flip_best_side_to_over():
    ...
    games_norm = {
        ...
        "records": [
            _norm_record(
                ...
                8.5,
                "OVER",
                [{"book": "DK", "odds": -125}, {"book": "FD", "odds": -125}],
                stats=_l10_stats(10, 10),
            ),
            _norm_record(
                "m1", 8.5, "UNDER", [{"book": "DK", "odds": 105}, {"book": "FD", "odds": 105}]
            ),
        ],
    }
    rows = build_game_totals(
    ...
    no_stats = {
        ...
        "records": [
            _norm_record(
                "m1", 8.5, "OVER", [{"book": "DK", "odds": -125}, {"book": "FD", "odds": -125}]
            ),
            _norm_record(
                "m1", 8.5, "UNDER", [{"book": "DK", "odds": 105}, {"book": "FD", "odds": 105}]
            ),
    ...
    market_row = build_game_totals(
        [], no_stats, sport="MLB", now=datetime(2026, 7, 7, 13, tzinfo=timezone.utc)
    )[0]
...
def test_implied_prob_scaling_and_rounding():
    games_norm = {
        ...
        "records": [
            _norm_record(
                "m_imp", 8.5, "OVER", [{"book": "DK", "odds": -110}, {"book": "FD", "odds": -110}]
            ),
            _norm_record(
                "m_imp", 8.5, "UNDER", [{"book": "DK", "odds": -110}, {"book": "FD", "odds": -110}]
            ),
        ],
    }
    candidates = [
    ...
    totals_rows = [
        {
            ...
            "matchup": "MIN @ TOR",
            "team": "MIN",
            "selection": "Total OVER 160.5",
        },
        {
            "event_id": "E_OFF",
            "matchup": "GSV @ PHX",
            "team": "GSV",
            "selection": "Total OVER 156.5",
        },
    ]
...
def test_fair_total_directional_divergence_flag():
    ...
    records = [
        _norm_record(
            ...
            8.5,
            "OVER",
            [{"book": "DraftKings", "odds": -180}, {"book": "FanDuel", "odds": -180}],
            event_id="EV1",
        ),
        _norm_record(
            "m_game",
            8.5,
            "UNDER",
            [{"book": "DraftKings", "odds": 150}, {"book": "FanDuel", "odds": 150}],
            event_id="EV1",
        ),
        _norm_record(
            "m_game",
            9.5,
            "OVER",
            [{"book": "DraftKings", "odds": -140}, {"book": "FanDuel", "odds": -140}],
            event_id="EV1",
        ),
        _norm_record(
            "m_game",
            9.5,
            "UNDER",
            [{"book": "DraftKings", "odds": 120}, {"book": "FanDuel", "odds": 120}],
            event_id="EV1",
        ),
        _norm_record(
            "m_game",
            10.5,
            "OVER",
            [{"book": "DraftKings", "odds": 110}, {"book": "FanDuel", "odds": 110}],
            event_id="EV1",
        ),
        _norm_record(
            "m_game",
            10.5,
            "UNDER",
            [{"book": "DraftKings", "odds": -130}, {"book": "FanDuel", "odds": -130}],
            event_id="EV1",
        ),
    ]
    games_norm = {"generated_at": "2026-07-30T12:00:00Z", "records": records}
    rows = build_game_totals(
        cards, games_norm, sport="MLB", now=datetime(2026, 7, 30, 13, tzinfo=timezone.utc)
    )
    assert len(rows) > 0
    row = rows[0]
    assert row["fair_total"] != ""
