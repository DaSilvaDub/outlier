...
When the briefing, `game_totals.csv`, or `team_totals.csv` lists totals for a game, you MUST research total-relevant context:
...
- Team totals (`team_totals.csv`): same injury/pace/script factors, scoped to the named team.
