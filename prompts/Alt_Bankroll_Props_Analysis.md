...
### 3.1 Provided Data
The attached CSV data contains the allowed alternate lines. These have already been filtered for full-game scope, HardRock-exclusive availability, exactly 100% L5, at least 90% L10, and odds between -1000 and -500.
...
* Every prop is a full-game HardRock line in the -1000 through -500 range with L5=100% and L10>=90%.
